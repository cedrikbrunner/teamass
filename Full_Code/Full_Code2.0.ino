...
float mminsteps = 3; // 1 mm = 10 steps (needs to be determined) 1.587
int sensordistancemm = 222; // distance between the sensors in mm
int totaldistancemm = 351; // distance in mm from sensor 1 to where middle of board needs to be 
